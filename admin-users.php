            ...
            <div class="col-sm-10 offset-1">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th class="col-sm-2" scope="col">First Name</th>
                        <th class="col-sm-2" scope="col">Last Name</th>
                        <th class="col-sm-2" scope="col">Email</th>
                        <th class="col-sm-1" scope="col">Gender</th>
                        <th class="col-sm-2" scope="col">Birth of Date</th>
                        <th class="col-sm-1" scope="col">Operation</th>
